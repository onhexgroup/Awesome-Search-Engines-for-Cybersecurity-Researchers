...
| --- | --- | --- |
| https://blog.fautl.com/api-list.html | Windows API Arsenal:Serach Win API by name or categories + Interactive Malware Behavior Pattern Rcon & Att&ck Framework Mapping | NO |
